...
if __name__ == "__main__":
    analyzer = NetworkConfigAnalyzer(api_key=os.environ["ANTHROPIC_API_KEY"])
...
# Example usage
if __name__ == "__main__":
    analyzer = ConversationalConfigAnalyzer(api_key=os.environ["ANTHROPIC_API_KEY"])
...
# Example usage
if __name__ == "__main__":
    troubleshooter = NetworkTroubleshooter(api_key=os.environ["ANTHROPIC_API_KEY"])
...
# Example usage
if __name__ == "__main__":
    generator = NetworkConfigGenerator(api_key=os.environ["ANTHROPIC_API_KEY"])
...
# Example usage
if __name__ == "__main__":
    agent = create_network_agent(api_key=os.environ["ANTHROPIC_API_KEY"])
...
# Example
if __name__ == "__main__":
    assistant = NetworkAssistant(api_key=os.environ["ANTHROPIC_API_KEY"])
