@echo off
REM Push Volume 3 & 4 Colab notebooks to GitHub
REM Run this from: E:\vExpertAI\CONTENT\Book\AI_for_networking_and_security_engineers
...
REM Create commit
git commit -m "Add Volume 3 & 4 Colab notebooks" -m "" -m "- Volume 3: 6 notebooks (Ch 32, 34, 37, 48, 51, 61)" -m "  - Advanced Techniques (Fine-tuning, Multi-agent, Graph RAG)" -m "  - Production Deployment (Monitoring, Scaling, Case Study)" -m "" -m "- Volume 4: 6 notebooks (Ch 70, 72, 75, 80, 83, 87)" -m "  - Security Operations (Threat detection, SIEM, Anomaly detection)" -m "  - Securing AI (AI security, Compliance, Case Study)" -m "" -m "All notebooks include:" -m "- Simple, well-commented code" -m "- Setup instructions with API key configuration" -m "- Working examples" -m "- Interactive playground sections" -m "" -m "Co-Authored-By: Claude Sonnet 4.5 <noreply@anthropic.com>"
